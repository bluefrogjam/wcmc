...
@SpringBootTest(webEnvironment = WebEnvironment.DEFINED_PORT, classes = Array(classOf[edu.ucdavis.fiehnlab.wcmc.server.fserv.FServ], classOf[FServ4jClientConfiguration]))
