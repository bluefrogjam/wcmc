...
package object api {
  ...
  /**
    ...
    */
  val testSpectraWith1Ion = MSSpectraImpl(scanNumber = 1, ions = Ion(100, 100) :: List(), retentionTimeInSeconds = 1000,massOfDetectedFeature = Option(Ion(100,100)))

  /**
    * test spectra with 2 ions
    */
  val testSpectraWith2Ions = MSSpectraImpl(2, Ion(100, 100) :: Ion(120, 50) :: List(), 2000,massOfDetectedFeature = Option(Ion(100,100)))

  /**
    * test spectra with 2 ions
    */
  val testSpectraWith3Ions = MSSpectraImpl(3, Ion(100, 10) :: Ion(120, 50) :: Ion(130, 100) :: List(), 3000,massOfDetectedFeature = Option(Ion(100,100)))

  /**
    * test spectra with 2 ions
    */
  val testSpectraWith4Ions = MSSpectraImpl(4, Ion(100, 50) :: Ion(120, 50) :: Ion(130, 100) :: Ion(140, 10) :: List(), 4000,massOfDetectedFeature = Option(Ion(100,100)))

  val testAccurateMassSpectraWith4Ions = MSSpectraImpl(5, Ion(100.3241, 50) :: Ion(120.2132, 50) :: Ion(130.1321, 100) :: Ion(140.2224, 10) :: List(), 5000,massOfDetectedFeature = Option(Ion(100.3241,50)))
  val testAccurateMassSpectraWith4Ions2 = MSSpectraImpl(6, Ion(100.3241, 50) :: Ion(100.3242, 50) :: Ion(100.2339, 100) :: Ion(140.2224, 10) :: List(), 6000,massOfDetectedFeature = Option(Ion(100.3241,50)))
