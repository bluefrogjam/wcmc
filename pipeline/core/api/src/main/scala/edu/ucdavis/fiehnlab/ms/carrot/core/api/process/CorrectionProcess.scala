...
/**
  ...
  * @param libraryAccess
  */
abstract class CorrectionProcess @Autowired()(val libraryAccess: LibraryAccess[Target], val stasisClient: StasisService) extends AnnotationProcess[Target, Sample, CorrectedSample](libraryAccess, stasisClient) with LazyLogging {
