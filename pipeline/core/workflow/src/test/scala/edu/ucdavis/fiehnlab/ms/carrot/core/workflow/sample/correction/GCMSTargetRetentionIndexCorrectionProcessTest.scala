...
class GCMSTargetRetentionIndexCorrectionProcessWithDeconvoulutionTest extends GCMSTargetRetentionIndexCorrectionProcessTest with Matchers {
  ...
  override protected def prepareSample(sample: Sample): Sample = {
    peakPicking.process(sample, method, None)
  }
      ...
      "allow to process data while loading a configuration from the Gerstel default Method" ignore {
        ...
        "for sample 060712afisa86_1" should {
          ...
          "be at least as good as past calculation in BinBase" in {
            ...
            val result = correction.process(prepareSample(sampleLoader.getSample("060712afisa86_1." + filexExtension)), method, None)
        ...
        "for sample 180321bZKsa26_1" should {
          ...
          "be at least as good as past calculation in BinBase" in {
            ...
            val result = correction.process(prepareSample(sampleLoader.getSample("180321bZKsa26_1." + filexExtension)), method, None)
