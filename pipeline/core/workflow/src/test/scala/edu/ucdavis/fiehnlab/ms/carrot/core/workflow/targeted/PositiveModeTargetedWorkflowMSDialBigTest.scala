...
class PositiveModeTargetedWorkflowMSDialBigTest extends PositiveModeTargetedWorkflowTest {
	@Autowired
	...
	def experimentDefinition: InputStream = getClass.getResourceAsStream("/full/qcExperimentMSDial_full.txt")
